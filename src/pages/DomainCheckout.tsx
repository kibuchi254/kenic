...
export default function DomainCheckout() {
  ...
  const { domain, price, renewal } = location.state || {
    domain: "myawesomebrand.co.ke",
    price: 1200,
    renewal: 1200,
  }; // Fallback values if state is undefined
  ...
  const handleCheckout = (e) => {
    e.preventDefault();
    alert(`Processing payment via ${paymentMethod.toUpperCase()} for ${domain}...`);
  };
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow p-6">
            ...
            <div className="mt-4 border-t pt-4 space-y-2">
              ...
              <p className="text-gray-600">Registration Price: KES {price.toLocaleString()}</p>
              <p className="text-gray-600">Annual Renewal: KES {renewal.toLocaleString()}</p>
            </div>
          </div>
          ...
          <form onSubmit={handleCheckout} className="bg-white rounded-2xl shadow p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center p-4 border rounded-lg ${
                  paymentMethod === "paypal" ? "border-green-600 bg-green-50" : "border-gray-300"
                }`}
              >
